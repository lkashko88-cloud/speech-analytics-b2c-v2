...
const PRODUCTS = ['Интернет', 'ТВ', 'Приставка', 'Роутер', 'Домофония', 'Видеонаблюдение'];
...
// ARPU from real pilot data (confirmed by OCP reports)
const PRODUCT_ARPU = {
  'Интернет': 889,          // подписка/мес
  'ТВ': 626,               // подписка/мес
  'Приставка': 5500,        // разовая продажа
  'Роутер': 3228,           // разовая продажа
  'Домофония': 130,         // подписка/мес
  'Видеонаблюдение': 300,   // подписка/мес
};
